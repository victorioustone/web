 ...
 * @category Cheerio
 */
export type { Cheerio } from 'cheerio/src/cheerio';
/**
 * Types used in signatures of Cheerio methods.
 *
 * @category Cheerio
 */
export * from 'cheerio/src/types';
export type { CheerioOptions, HTMLParser2Options, Parse5Options, } from 'cheerio/src/options';
/**
...
export * from 'cheerio/src/load';
declare const _default: import("cheerio/src/load").CheerioAPI;
/**
...
import * as staticMethods from 'cheerio/src/static';
/**
